...
docker exec smart-screen-db-1 psql -U smartscreen -d smartscreen -c "INSERT INTO _prisma_migrations (id, checksum, migration_name, finished_at, applied_steps_count) VALUES ('a1b2c3d4-e5f6-a1b2-c3d4-e5f6a1b2c3d4', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '20260720130000_add_security_analytics_holidays_telemetry_ota', NOW(), 1);"
