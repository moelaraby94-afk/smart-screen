...
docker exec smart-screen-db-1 psql -U smartscreen -d smartscreen -c "\d _prisma_migrations"
...
docker exec smart-screen-db-1 psql -U smartscreen -d smartscreen -c "INSERT INTO _prisma_migrations (id, migration_name, finished_at, applied_steps_count) VALUES ('a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4', '20260720130000_add_security_analytics_holidays_telemetry_ota', NOW(), 1);"
