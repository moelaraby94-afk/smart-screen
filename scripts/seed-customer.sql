...
VALUES ('clcustomer0000000000000001', 'customer@cloudscreen.io', 'Test Customer', '$2b$12$YyFrUhZKMVarFFO/d9.Iu.ZwkhGxytXFUsNCCRjm/g74JWn7HKtuy', true, false, NOW(), NOW(), 'Customer Business', '+201234567890', 'EG')
...
WHERE EXISTS (SELECT 1 FROM "User" WHERE email = 'customer@cloudscreen.io')
